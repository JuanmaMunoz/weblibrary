...
import { IAccordion } from 'projects/lib/src/public-api';
...
export class DemoAccordionComponent {
  ...
  public accordionItems: IAccordion[] = [
    ...
    },
    {
      ...
      description:
        'In a <span class="text-primary">large mixing bowl</span>, whisk together the sugar, flour, cocoa powder, and salt. <p> Beat the eggs into the dry ingredients until well combined.</p> ',
      open: false,
    },
  ];
